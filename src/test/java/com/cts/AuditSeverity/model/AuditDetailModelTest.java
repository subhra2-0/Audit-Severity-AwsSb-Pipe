...
public class AuditDetailModelTest {
	...
	public void testallargs() {
		Date date=new Date();
		AuditDetailModel detailModel=new AuditDetailModel(1,"sox",date);
		assertEquals(date, detailModel.getAuditDate());
	}
	@Test
	public void testall() {
		
		AuditDetailModel detailModel=new AuditDetailModel("sox");
		assertEquals("sox", detailModel.getAuditType());
	}
}
